...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> listHasNoAnyElementsException() {
       return new ResponseEntity<>(new MyGlobalExceptionHandler("This list is empty yet"), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<?> emptyDataException() {
        return new ResponseEntity<>(new MyGlobalExceptionHandler("You must wright data"), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(ListIsFullException.class)
    public ResponseEntity<?> theListFullException() {
        return new ResponseEntity<>(new MyGlobalExceptionHandler("The place from request is full already"), HttpStatus.FORBIDDEN);
    }

    @ExceptionHandler(WorkspaceIsNotActiveException.class)
    public ResponseEntity<?> workspaceIsNotActiveException() {
        return new ResponseEntity<>(new MyGlobalExceptionHandler("The workspace is not active, you should connect to another one"), HttpStatus.FORBIDDEN);
    }
